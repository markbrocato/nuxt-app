...
var _default = [{
  ...
  key: 'vue',
  name: 'Vue',
  builder: '@edgio/vue-cva',
  devDependencies: ['@edgio/vue', '@edgio/vue-cva'],
  framework: 'vue',
  ...
  key: 'sanity-studio',
  name: 'sanity-studio',
  builder: '@edgio/sanity-studio',
  devDependencies: ['@edgio/sanity-studio'],
  framework: '@sanity/core'
}, {
  key: 'sanity-studio',
  name: 'sanity-studio',
  builder: '@edgio/sanity-studio',
  ...
  name: 'qwik',
  builder: '@edgio/qwik',
  devDependencies: ['@edgio/qwik'],
  framework: '@builder.io/qwik'
}];
