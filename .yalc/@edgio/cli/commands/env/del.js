...
exports.handler = async yargs => {
  ...
  const environmentDetails = [`> team=${teamSlug || 'Private space'}`, `> site=${siteSlug}`, `> environment=${environmentParam}`].filter(Boolean); // Removes falsy values
